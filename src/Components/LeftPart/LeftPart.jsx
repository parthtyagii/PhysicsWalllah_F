...
const LeftPart = () => {
    ...
    return (
        <div className='w-[32%] flex flex-col justify-start items-center gap-y-[1rem] bg-yellow-200 '>
            ...
            <div className="w-full grow flex flex-col justify-start gap-y-[1rem] overflow-y-auto ">
                <Intern />
                <Intern />
                <Intern />
            </div>
